  ...
  return (
    <div className="h-full flex flex-col">
      <div className="border-b border-gray-800 px-6 py-3 flex items-center justify-between shrink-0">
        ...
        <p className="text-xs text-gray-500">Test API calls without writing code</p>
      </div>

      <div className="flex-1 overflow-auto">
        {isRunning ? (
          <ApiPlayground instanceId={id} />
        ) : (
          <div className="flex items-center justify-center h-full">
            <div className="text-center">
              ...
              <p className="text-xs text-gray-500">Start your project from Settings to use the API Playground.</p>
            </div>
          </div>
        )}
      </div>
