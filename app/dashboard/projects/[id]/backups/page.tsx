  ...
  return (
    <div className="h-full flex flex-col">
      <div className="border-b border-gray-800 px-6 py-3 shrink-0">
        <h1 className="text-sm font-medium text-white">Backups</h1>
      </div>

      <div className="flex-1 overflow-auto p-6">
        {isRunning ? (
          <BackupsPanel instanceId={id} />
        ) : (
          <div className="flex items-center justify-center h-full">
            <div className="text-center">
              ...
              <p className="text-xs text-gray-500">Start your project from Settings to manage backups.</p>
            </div>
          </div>
        )}
      </div>
