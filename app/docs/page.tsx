            ...
            <header className="sticky top-0 z-50 w-full border-b border-gray-200 dark:border-gray-800 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm">
                <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                    <Link href="/" className="flex items-center gap-2">
                        <svg className="w-8 h-8 text-primary-600 dark:text-primary-400" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="max-w-7xl mx-auto px-6 py-12 flex flex-col lg:flex-row gap-12">
                ...
                <main className="flex-1 min-w-0 prose prose-lg dark:prose-invert max-w-none">
                    ...
                    <section id="before-you-start" className="scroll-mt-24 mt-12">
                        ...
                        <p>You need two things from the <a href="https://picobase.com/dashboard" className="text-primary-600 hover:underline">PicoBase dashboard</a>:</p>
                        <ol className="list-decimal pl-6 space-y-2 text-gray-700 dark:text-gray-300">
                            <li><strong>Your instance URL</strong> — looks like <code>https://myapp.picobase.com</code></li>
